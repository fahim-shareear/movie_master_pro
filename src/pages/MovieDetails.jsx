    ...
    const handleAddToWatchlist = async () => {
        ...
        try {
            const watchData = {
                ...
                moviePoster: movie.posterImg || movie.posterUrl,
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full lg:w-1/3 relative">
                        <img src={movie.posterImg || movie.posterUrl} alt={movie.title} className="w-full rounded-3xl shadow-2xl border border-white/10" />
